...
def property_details(property_id):
    ...
    if session.get('user'):
        ...
        cursor.close()
    return render_template('pages/details.html', property=property_data, image=primary_image, gallery_images=gallery_images, amenities=amenities, nearby=uni_nearby, documents=documents, has_offer=has_offer)
